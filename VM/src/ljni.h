...
struct JNINativeInterface_ {
    ...
    void (JNICALL *ReleaseStringUTFChars)(JNIEnv* env, jstring str, const char* utf);
...
struct JNIEnv_ {
    ...
    jobject NewObject(jclass clazz, jmethodID methodID, ...) {
        ...
        jobject res = functions->NewObjectV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jobject CallObjectMethod(jobject obj, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jobject res = functions->CallObjectMethodV(this, obj, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jboolean CallBooleanMethod(jobject obj, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jboolean res = functions->CallBooleanMethodV(this, obj, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jbyte CallByteMethod(jobject obj, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jbyte res = functions->CallByteMethodV(this, obj, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jchar CallCharMethod(jobject obj, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jchar res = functions->CallCharMethodV(this, obj, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jshort CallShortMethod(jobject obj, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jshort res = functions->CallShortMethodV(this, obj, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jint CallIntMethod(jobject obj, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jint res = functions->CallIntMethodV(this, obj, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jlong CallLongMethod(jobject obj, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jlong res = functions->CallLongMethodV(this, obj, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jfloat CallFloatMethod(jobject obj, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jfloat res = functions->CallFloatMethodV(this, obj, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jdouble CallDoubleMethod(jobject obj, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jdouble res = functions->CallDoubleMethodV(this, obj, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jobject CallStaticObjectMethod(jclass clazz, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jobject res = functions->CallStaticObjectMethodV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jboolean CallStaticBooleanMethod(jclass clazz, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jboolean res = functions->CallStaticBooleanMethodV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jbyte CallStaticByteMethod(jclass clazz, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jbyte res = functions->CallStaticByteMethodV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jchar CallStaticCharMethod(jclass clazz, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jchar res = functions->CallStaticCharMethodV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jshort CallStaticShortMethod(jclass clazz, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jshort res = functions->CallStaticShortMethodV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jint CallStaticIntMethod(jclass clazz, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jint res = functions->CallStaticIntMethodV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jlong CallStaticLongMethod(jclass clazz, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jlong res = functions->CallStaticLongMethodV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jfloat CallStaticFloatMethod(jclass clazz, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jfloat res = functions->CallStaticFloatMethodV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    jdouble CallStaticDoubleMethod(jclass clazz, jmethodID methodID, ...) {
        va_list args;
        va_start(args, methodID);
        jdouble res = functions->CallStaticDoubleMethodV(this, clazz, methodID, args);
        va_end(args);
        return res;
    }
    ...
    void ReleaseStringUTFChars(jstring str, const char* utf) { functions->ReleaseStringUTFChars(this, str, utf); }
